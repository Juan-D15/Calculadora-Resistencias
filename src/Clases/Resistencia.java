...
public class Resistencia {
    ...
    public String valoresMultiplicador() {
        switch (multiplicador) {
            case "0" ->
                this.multiplicador = "1";          //Negro
            case "1" ->
                this.multiplicador = "10";         //Marrón
            case "2" ->
                this.multiplicador = "100";        //Rojo
            case "3" ->
                this.multiplicador = "1000";       //Naranja
            case "4" ->
                this.multiplicador = "10000";      //Amarillo
            case "5" ->
                this.multiplicador = "100000";     //Verde
            case "6" ->
                this.multiplicador = "1000000";    //Azul
            case "7" ->
                this.multiplicador = "10000000";   //Violeta
            case "8" ->
                this.multiplicador = "100000000";  //Gris
            case "9" ->
                this.multiplicador = "1000000000"; //Blanco
            case "10" ->
                this.multiplicador = "0.1";       //Oro
            case "11" ->
                this.multiplicador = "0.01";      //Plata
            default ->
    ...
    public String valoresTolerancia() {
        ...
        switch (tolerancia) {
            case "0" ->
                this.tolerancia = Tolerancias[0];   //Marrón
            case "1" ->
                this.tolerancia = Tolerancias[1];   //Rojo
            case "2" ->
                this.tolerancia = Tolerancias[2];   //Verde
            case "3" ->
                this.tolerancia = Tolerancias[3];   //Azul
            case "4" ->
                this.tolerancia = Tolerancias[4];   //Violeta
            case "5" ->
                this.tolerancia = Tolerancias[5];   //Gris
            case "6" ->
                this.tolerancia = Tolerancias[6];   //Oro
            case "7" ->
                this.tolerancia = Tolerancias[7];   //Plata
            case "8" ->
                this.tolerancia = Tolerancias[8];   //Sin Banda
            default ->
                this.tolerancia = "0";
        }
        return tolerancia;
